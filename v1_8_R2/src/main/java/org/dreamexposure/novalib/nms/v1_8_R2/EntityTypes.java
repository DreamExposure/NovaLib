package org.dreamexposure.novalib.nms.v1_8_R2;
...
public class EntityTypes implements IEntityTypes {
    ...
    public void addCustomEntity(int entityId, String entityName, Class entityClass) {
        try {
            ...
            Method method = net.minecraft.server.v1_8_R2.EntityTypes.class.getDeclaredMethod("a", Class.class, String.class, int.class);
