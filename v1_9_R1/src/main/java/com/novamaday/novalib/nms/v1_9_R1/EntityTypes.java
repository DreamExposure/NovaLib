package com.novamaday.novalib.nms.v1_9_R1;
...
public class EntityTypes implements IEntityTypes {
    ...
    public void addCustomEntity(int entityId, String entityName, Class entityClass) {
        try {
            ...
            Method method = net.minecraft.server.v1_9_R1.EntityTypes.class.getDeclaredMethod("a", Class.class, String.class, int.class);
