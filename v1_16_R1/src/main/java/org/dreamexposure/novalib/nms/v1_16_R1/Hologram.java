package org.dreamexposure.novalib.nms.v1_16_R1;
...
public class Hologram implements IHologram {
    ...
    private final Map<Location, HologramEntity> registeredHolograms = new HashMap<>();
    ...
    private void setPosition(net.minecraft.server.v1_16_R1.Entity entity, Location location) {
