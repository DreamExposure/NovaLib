...
public enum NSound {
    ...
    //TODO: All the sounds I forgot to add to this list (yeah... there's quite a lot tbh)
    //1.14 Sounds
    ...
    BLOCK_SMOKER_PLACE("BLOCK_SMOKER_PLACE"),
    BLOCK_SWEET_BERRY_BUSH_BREAK("BLOCK_SWEET_BERRY_BUSH_BREAK"),
    BLOCK_SWEET_BERRY_BUSH_PLACE("BLOCK_SWEET_BERRY_BUSH_BREAK"),
    ...
    ENTITY_PARROT_IMITATE_PANDA("ENTITY_PARROT_IMITATE_PANDA"),
    ...
    ITEM_CROSSBOW_LOADING_START("ITEM_CROSSBOW_LOADING_SMART"),
    ...
    ITEM_SWEET_BERRIES_PICK_FROM_BUSH("ITEM_SWEET_BERRIES_PICK_FROM_BUSH"),
    ...
    NSound(String... _versionDependentNames) {
        versionDependentNames = _versionDependentNames;
    }
     ...
     *
     * @return corresponding <code>org.bukkit.Sound</code>
     */
